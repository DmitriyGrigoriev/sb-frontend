<template>
  <div class="column">
    <q-item-label header class="q-px-none">{{ $t('components.announcements.label') }} <mini-refresh @click="refetch" /></q-item-label>
        ...
        <q-list>
          ...
          <template v-else>
            ...
            <q-item v-else>
              ...
              <q-item-section>
                <q-item-label>{{ $t('components.announcements.message') }}</q-item-label>
              </q-item-section>
            </q-item>
          </template>
        </q-list>
